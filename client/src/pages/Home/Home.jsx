      ...
      <Header/>
        <div className='bg-[#FFF9F9] flex w-full items-center grid grid-cols-2 gap-8 p-40'>
          <div>
            ...
            <h1 className='text-[#000000] font-bold text-5xl mb-3 leading-snug'>We Provide Truly Creative<br/>
          ...
          <div className='text-6xl items-center text-center ml-60'><img src='../src/assets/corporate_image1.png'/></div>
        </div>
      <Footer/>
      </div>
  )
