    ...
    <div>
      <Header/>
        <div className='bg-[#FFF9F9] flex flex-wrap md:text-left md:grid grid-cols-2 md:justify-center md:p-10 md:items-center md:mb-2'>
          <div className='m-3 p-2 md:m-20'>
            <h2 className='uppercase mb-2'>Digital Solution</h2>
            <h1 className='text-[#000000] text-4xl font-bold md:font-bold md:text-5xl md:mb-3 leading-snug'>We Provide Truly Creative<br/>
          ...
          <div className='p-2 m-2 md:p-10 md:justify-center md:items-center'><img src='../src/assets/corporate_image1.png'/></div>
        </div>
      <Footer/>
    </div>
  )
