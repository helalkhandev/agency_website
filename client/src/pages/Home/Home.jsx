      ...
      <Header/>
        <div className='bg-[#FFF9F9] flex flex-wrap md:text-left md:grid grid-cols-2 md:justify-center md:p-10 md:items-center md:mb-2'>
          <div className='m-8 p-2 md:m-20'>
            ...
            <h1 className='text-[#000000] text-2xl font-bold md:font-bold md:text-5xl md:mb-3 leading-snug'>We Provide Truly Creative<br/>
            ...
            <button className='bg-[#C1EBE1] px-3 py-1 text-lg font-semibold mt-2 hover:bg-[#20F1BF] rounded-lg'>Get Start Now</button>
          </div>
          <div className='p-2 m-2 md:p-10 md:flex md:justify-center md:items-center'><img src='../src/assets/corporate_image1.png'/></div>
        </div>
      <Footer/>
    </div>
  )
